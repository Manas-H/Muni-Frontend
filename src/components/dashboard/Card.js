      ...
      <Link to="/campus-request">
        <div className="flex items-center border bg-white md:w-60 h-16 cursor-pointer rounded-lg m-3 shadow-lg">
          ...
          <div className="flex flex-col  items-start">
            ...
            <h2 className="text-[10px] text-[#6f6f79]">
              Send Invite to Institute
            </h2>
          </div>
        </div>
      </Link>

      <Link to="/jobs/view-application">
        <div className="flex items-center border bg-white md:w-60 h-16 cursor-pointer rounded-lg m-3 shadow-lg">
          <div className="flex items-center px-3">
          ...
          <div className="flex flex-col  items-start">
            ...
            <h2 className="text-[10px] text-[#6f6f79]"> </h2>
          </div>
        </div>
      </Link>

      <Link to="https://myseagull.ai/placement/campusoutreach">
